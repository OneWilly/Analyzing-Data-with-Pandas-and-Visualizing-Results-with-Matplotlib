...
3. **Run the Python Script**:
   ...
   ```bash
   python3 iris_analysis_and_visualization.py
   ```

4. **Open the Jupyter Notebook**:
   If you prefer an interactive environment, open the notebook:
   ```bash
   jupyter notebook iris_analysis_and_visualization.ipynb
   ```
...
1. **Line Chart**: Petal length trends by species.
2. **Bar Chart**: Average petal width by species.
3. **Histogram**: Distribution of sepal length.
4. **Scatter Plot**: Sepal length vs. petal length.
5. **Pairplot**: Pairwise relationships among features.
...
4. The pairplot shows clear separations among species in petal-related dimensions.

---

## Acknowledgments

- This project is part of an assignment by **William Oneka**.
- The Iris dataset is a classic dataset in machine learning and statistics.
- Thanks to the developers of Python, Pandas, Matplotlib, Seaborn, and Scikit-learn for their amazing tools.
